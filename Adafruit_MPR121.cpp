...
boolean Adafruit_MPR121::begin(uint8_t i2caddr) {
  ...
  writeRegister(MPR121_CONFIG2, 0x3A); // 0.5us encoding, 18 samples, 4ms
  // period
  // writeRegister(MPR121_CONFIG2, 0x58); // 1uS encoding, 18 samples 2nd level
  // filter, 1ms period between samples
